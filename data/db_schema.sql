...
VALUES ('Főoldal', 'Home'),
       ...
       ('Vizuális észlelési készségek', 'Visual perception skills'),
       ('Ebben a tesztben felmérjük a vizuális észlelési képességed','In this test we assess your ability in visual perception'),
       ('Ebben a tesztben felmérjük a szociális készségeid','In this test we assess your social skills'),
